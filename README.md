...
2) If you are not using Microsoft SQL Server Management Studio. In the ONX.CRM solution in StartUp, change the connection string from "msSql" to "msSqlDefault".
